...
exports.get_AgentBugSi = exports.get_newAgentALT = exports.get_newAgent = void 0;
const f_to_app_1 = require("./f.to.app");
const AGENTUSER_ALT = [
    'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:34.0) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/' + (0, f_to_app_1.randomIntFromInterval)(54, 99) + '.0.4844.73 Mobile Safari/537.36',
    'Mozilla/5.0 (Linux; Android 11; SM-A315G Build/RP1A.200720.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/' + (0, f_to_app_1.randomIntFromInterval)(54, 99) + '.0.4844.73 Mobile Safari/537.36',
    'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/' + (0, f_to_app_1.randomIntFromInterval)(54, 99) + '.0.3904.97 Safari/537.36 OPR/65.0.3467.48',
    'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.14; rv:70.0) Gecko/20100101 Firefox/71.0',
    'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Safari/' + (0, f_to_app_1.randomIntFromInterval)(34, 99) + '5.1.15',
    'Mozilla/5.0 (Windows NT 6.1; Win64; x64) Gecko/20100101 Firefox/71.0',
    'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/' + (0, f_to_app_1.randomIntFromInterval)(54, 99) + '.0.3282.119 Safari/537.36',
    'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Safari/605.1.15',
    'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/' + (0, f_to_app_1.randomIntFromInterval)(54, 99) + '.0.4692.99 Safari/537.36',
    'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:98.0) Gecko/20100101 Firefox/98.0',
    'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/' + (0, f_to_app_1.randomIntFromInterval)(54, 101) + '.0.4951.54 Safari/537.36',
    'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/' + (0, f_to_app_1.randomIntFromInterval)(54, 101) + '.0.4280.88 Safari/537.36',
    "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:99.0) Gecko/20100101 Firefox/" + (0, f_to_app_1.randomIntFromInterval)(54, 99) + ".0",
    'Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.0; Trident/' + (0, f_to_app_1.randomIntFromInterval)(5, 99) + '.0)',
    'Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; WOW64; Trident/' + (0, f_to_app_1.randomIntFromInterval)(5, 99) + '.0)',
    'Mozilla/5.0 (X11; Linux x86_64) Gecko/20100101 Firefox/' + (0, f_to_app_1.randomIntFromInterval)(54, 99) + '.0',
    'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/' + (0, f_to_app_1.randomIntFromInterval)(54, 99) + '.0.4844.82 Safari/537.36',
    'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Safari/' + (0, f_to_app_1.randomIntFromInterval)(54, 99) + '5.1.15',
    "Mozilla/5.0 (X11; Linux i686; rv:74.0) Gecko/20100101 Firefox/'+randomIntFromInterval(54,99)+'.0",
    "Mozilla/5.0 (Linux x86_64; rv:74.0) Gecko/20100101 Firefox/" + (0, f_to_app_1.randomIntFromInterval)(54, 99) + ".0",
    "Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:74.0) Gecko/20100101 Firefox/" + (0, f_to_app_1.randomIntFromInterval)(54, 99) + ".0",
    "Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:74.0) Gecko/20100101 Firefox/" + (0, f_to_app_1.randomIntFromInterval)(54, 99) + ".0",
    "Mozilla/5.0 (X11; Fedora; Linux x86_64; rv:74.0) Gecko/20100101 Firefox/" + (0, f_to_app_1.randomIntFromInterval)(54, 99) + ".0",
    'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/' + (0, f_to_app_1.randomIntFromInterval)(54, 103) + '.0.' + (0, f_to_app_1.randomIntFromInterval)(4951, 5060) + '.' + (0, f_to_app_1.randomIntFromInterval)(64, 114) + ' Safari/537.36 Edg/' + (0, f_to_app_1.randomIntFromInterval)(64, 103) + '.0.' + (0, f_to_app_1.randomIntFromInterval)(1210, 1264) + '.' + (0, f_to_app_1.randomIntFromInterval)(49, 53),
];
var AGENTUSER = [
    'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:34.0) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/' + (0, f_to_app_1.randomIntFromInterval)(54, 99) + '.0.4844.73 Mobile Safari/537.36',
    'Mozilla/5.0 (Linux; Android 11; SM-A315G Build/RP1A.200720.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/' + (0, f_to_app_1.randomIntFromInterval)(54, 99) + '.0.4844.73 Mobile Safari/537.36',
...
function get_newAgent(agentPos = -1) {
    if (agentPos <= -1 || agentPos > (AGENTUSER.length - 1)) {
        return (AGENTUSER[(0, f_to_app_1.randomIntFromInterval)(0, AGENTUSER.length - 1)]);
    }
    else {
        return AGENTUSER[agentPos];
    }
}
exports.get_newAgent = get_newAgent;
async function get_newAgentALT(agentPos = -1) {
    if (agentPos <= -1 || agentPos > (AGENTUSER_ALT.length - 1)) {
        return (AGENTUSER_ALT[(0, f_to_app_1.randomIntFromInterval)(0, AGENTUSER_ALT.length - 1)]);
    }
    else {
        return AGENTUSER_ALT[agentPos];
    }
}
exports.get_newAgentALT = get_newAgentALT;
function get_AgentBugSi() {
    return 'Mozilla/5.0 (Macintosh; Mac 11_2_1) AppleWebKit/537.36 (KHTML, like Gecko) Edg/99.0.1150.36';
}
exports.get_AgentBugSi = get_AgentBugSi;
