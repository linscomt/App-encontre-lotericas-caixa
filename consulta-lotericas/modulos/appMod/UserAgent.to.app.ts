/*-- UserAgent.to.app  (.ts) (.js) --*/

import {randomIntFromInterval} from './f.to.app';


/*
ESSE AGENT REINICIA o LOGIN
'Mozilla/5.0 (Macintosh; Mac 11_2_1) AppleWebKit/537.36 (KHTML, like Gecko) Edg/99.0.1150.36',
*/

/**/
const AGENTUSER_ALT=[
	
	/*00*/'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:34.0) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'+randomIntFromInterval(54,99)+'.0.4844.73 Mobile Safari/537.36',
	/*00*/
	/*00*//*ANDROID*/
	/*00*/'Mozilla/5.0 (Linux; Android 11; SM-A315G Build/RP1A.200720.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'+randomIntFromInterval(54,99)+'.0.4844.73 Mobile Safari/537.36',
	/*00*//*MAC*/
	/*00*/'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'+randomIntFromInterval(54,99)+'.0.3904.97 Safari/537.36 OPR/65.0.3467.48',
	/*00*/'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.14; rv:70.0) Gecko/20100101 Firefox/71.0',
	/*00*/'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Safari/'+randomIntFromInterval(34,99)+'5.1.15',
	/*00*//*W7*/
	/*00*//*-ERRO no FireFox OLD-*/'Mozilla/5.0 (Windows NT 6.1; Win64; x64) Gecko/20100101 Firefox/71.0', 
	/*00*/'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'+randomIntFromInterval(54,99)+'.0.3282.119 Safari/537.36',
	/*00*/'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Safari/605.1.15',
	/*00*//*W10*/
	
	
	/*00*/'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'+randomIntFromInterval(54,99)+'.0.4692.99 Safari/537.36',
	/*00*/'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:98.0) Gecko/20100101 Firefox/98.0',
	/*00*/'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'+randomIntFromInterval(54,101)+'.0.4951.54 Safari/537.36',
	/*00*/'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'+randomIntFromInterval(54,101)+'.0.4280.88 Safari/537.36',
	/*00*/"Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:99.0) Gecko/20100101 Firefox/"+randomIntFromInterval(54,99)+".0",
	/*00*//*WVista*/
	/*00*/'Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.0; Trident/'+randomIntFromInterval(5,99)+'.0)',
	/*00*//*W8*/
	/*00*/'Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; WOW64; Trident/'+randomIntFromInterval(5,99)+'.0)',
	/*00*//*LINUX*/
	/*00*/'Mozilla/5.0 (X11; Linux x86_64) Gecko/20100101 Firefox/'+randomIntFromInterval(54,99)+'.0',
	/*00*/'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'+randomIntFromInterval(54,99)+'.0.4844.82 Safari/537.36',
	/*00*/'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Safari/'+randomIntFromInterval(54,99)+'5.1.15',
	/*00*/"Mozilla/5.0 (X11; Linux i686; rv:74.0) Gecko/20100101 Firefox/'+randomIntFromInterval(54,99)+'.0",
    /*00*/"Mozilla/5.0 (Linux x86_64; rv:74.0) Gecko/20100101 Firefox/"+randomIntFromInterval(54,99)+".0",
    /*00*/"Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:74.0) Gecko/20100101 Firefox/"+randomIntFromInterval(54,99)+".0",
    /*00*/"Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:74.0) Gecko/20100101 Firefox/"+randomIntFromInterval(54,99)+".0",
    /*00*/"Mozilla/5.0 (X11; Fedora; Linux x86_64; rv:74.0) Gecko/20100101 Firefox/"+randomIntFromInterval(54,99)+".0",
	/*00*///'Mozilla/5.0 (Macintosh; Mac 10_2_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4844.51 Safari/537.36',
	/*00*///'Mozilla/5.0 (iPod touch; CPU iPhone OS 12_2_1 like Mac OS X) AppleWebKit/604.5.6 (KHTML, like Gecko) FxiOS/98.0 Mobile/15E148 Safari/605.1.15',
	/*00*//*-EDGE-*/
	///*00*/'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.5060.114 Safari/537.36                                                                                            Edg/103.0.1264.49',
	/*00*/'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'+randomIntFromInterval(54,103)+'.0.'+randomIntFromInterval(4951,5060)+'.'+randomIntFromInterval(64,114)+' Safari/537.36 Edg/'+randomIntFromInterval(64,103)+'.0.'+randomIntFromInterval(1210,1264)+'.'+randomIntFromInterval(49,53),
...
'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Ubuntu Chrome/37.0.2062.94 Safari/537.36',
...
'Mozilla/5.0 (iPhone; CPU iPhone OS 11_0 como Mac OS X) AppleWebKit/537.36 (KHTML, como Gecko) Chrome/98.0.4758.101 Mobile Safari/537.36',
//'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) HeadlessChrome/100.0.4896.127 Safari/537.36',
'Mozilla/5.0 (Linux; Android 5.1; XT1033 Build/LPBS23.13-56-2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/59.0.3071.125 Mobile Safari/537.36',
//'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) HeadlessChrome/101.0.4951.67 Safari/537.36',
...
function get_newAgent(agentPos=-1){
	if(agentPos<=-1 || agentPos >(AGENTUSER.length-1) ){
		return(AGENTUSER[randomIntFromInterval(0,AGENTUSER.length-1)]);
	}
	else{
		return AGENTUSER[agentPos];
	}
}

async function get_newAgentALT(agentPos=-1){
	if(agentPos<=-1 || agentPos >(AGENTUSER_ALT.length-1) ){
		return(AGENTUSER_ALT[randomIntFromInterval(0,AGENTUSER_ALT.length-1)]);
	}
	else{
		return AGENTUSER_ALT[agentPos];
	}
} 

function get_AgentBugSi(){
	/*ESSE AGENT REINICIA o LOGIN*/
	return 'Mozilla/5.0 (Macintosh; Mac 11_2_1) AppleWebKit/537.36 (KHTML, like Gecko) Edg/99.0.1150.36';
}



//module.exports = { get_newAgent, get_AgentBugSi }
export { get_newAgent, get_newAgentALT, get_AgentBugSi }