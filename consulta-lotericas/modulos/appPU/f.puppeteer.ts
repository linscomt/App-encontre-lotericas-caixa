 ...
 */
  async function Create( URLProxy_PORT, ProxyPWD, define=''){ //Proxy_username, Proxy_password
	...
	//const LOCALBROWSER='/snap/bin/chromium';
	//const LOCALBROWSERs=[
	//	'/snap/bin/chromium', //linux debian
...
//  /tmp/snap.chromium/tmp/.snap/snap/chromium
//  /var/snap/chromium
//  /snap/chromium
//  /snap/bin/chromium
//  /snap/core20/1585/usr/share/bash-completion/completions/chromium
//  /snap/core20/1522/usr/share/bash-completion/completions/chromium
//  root@srv-sms:~# 
...
try{
	...
	//console.log('BODY:',hBody);
	//await write_file('./dados_pesquisados/ht.get_codeHtml.render.'+cpf+'.html', hBody );
	return await hBody;
}catch(e){return false}
}
	  ...
	  if (res) {
		await iframe.evaluate(async (a, res) => {
		  ...
		  a.innerHTML = res;
			  ...
			  await write_file('./dados_pesquisados/ERROR_DADOS_.html', 'ERROR:#003:'+e+'PAG:'+page);
		  }
		}, res);
	  }
	}
